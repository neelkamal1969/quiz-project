...
const ICONS = {
  ...
  instagram: (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204 0x12-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163C8.741 0 8.332.014 7.052.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z" />
    </svg>
  ),
  mail: (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function Footer() {
  ...
  return (
    <footer style={{ position: 'relative', borderTop: '1px solid var(--glass-border)', background: 'var(--glass-bg-light)', backdropFilter: 'var(--glass-blur)', WebkitBackdropFilter: 'var(--glass-blur)' }}>
      ...
      {/* Reimagined Ultra-Premium Bottom Bar */}
      <div className="premium-footer-bar">
        <style>{`
          ...
          .signature-capsule:hover {
            transform: translateY(-2px);
            background: rgba(255, 255, 255, 0.05);
            border-color: rgba(var(--accent-rgb, 120, 119, 198), 0.4);
            box-shadow: 0 6px 24px rgba(0, 0, 0, 0.3), inset 0 0 12px rgba(255, 255, 255, 0.02);
          }
          .sig-prefix {
            font-size: 10px;
          ...
          .sig-name-mridul::after {
            content: '█';
            font-size: 10px;
            color: var(--text-secondary);
            margin-left: 4px;
            animation: dev-cursor-blink 0.9s infinite steps(2, start);
          }
          .sig-name-neel {
            ...
            animation: ds-holo-pan 4s linear infinite;
            padding-right: 1px;
          }
          .sig-dot-divider {
            width: 4px;
        ...
        <div className="footer-copyright">
          © {new Date().getFullYear()} <span style={{ fontWeight: 700, color: 'var(--text-primary)' }}>StudyAI</span> · All rights reserved.
        </div>
        ...
        <div className="footer-signatures">
          ...
          <div className="signature-capsule" title="Interface Designer">
            <span className="sig-prefix">Designed by</span>
            <span className="sig-name-neel">Neelkamal Gupta</span>
          </div>
        </div>
      </div>
